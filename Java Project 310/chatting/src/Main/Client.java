...
public class Client  implements ActionListener{
      ...
      Client() {
            ...
            ImageIcon back1 = new ImageIcon(ClassLoader.getSystemResource("icons/wall2.jpg"));
            Image back2 = back1.getImage().getScaledInstance(425,543,Image.SCALE_DEFAULT);
      ...
      public static void main(String[] args) {
		...
		// // Thread t2 = new Thread(new Client());	t2.start();
